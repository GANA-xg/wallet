...
const FEATURES = [
  ...
  { icon: "repeat" as const, label: "Subscriptions", sub: "Recurring payments", route: "/subscriptions", color: "#8B5CF6" },
  { icon: "trending-up" as const, label: "Cash Flow", sub: "Forecast & safe to spend", route: "/cashflow", color: "#10B981" },
  { icon: "bar-chart-2" as const, label: "Analytics", sub: "Spending insights", route: "/analytics", color: "#F59E0B" },
