    ...
    <View style={[styles.container, style]}>
      ...
      >
        ...
        >
          ...
          <View style={styles.bottomRow}>
            ...
            <TouchableOpacity onPress={flipCard} style={styles.cvvBtn}>
              <Feather name="eye" size={14} color="rgba(255,255,255,0.6)" />
            </TouchableOpacity>
          </View>
        </LinearGradient>
      </Animated.View>
      ...
      >
        ...
        >
          ...
          <TouchableOpacity onPress={flipCard} style={styles.flipBackBtn}>
            <Feather name="rotate-ccw" size={14} color="rgba(255,255,255,0.6)" />
