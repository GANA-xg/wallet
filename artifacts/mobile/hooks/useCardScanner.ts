...
import { trackDuplicateDetected, trackScanConfirmed } from "@/services/cards/analytics";
import { cleanupTempFiles, processCapturedImage } from "@/services/cards/scanner";
import type { CardRecord, ScanSession, ValidatedCard } from "@/services/cards/types";
...
export function useCardScanner(existingCards: CardRecord[] = []): UseCardScannerReturn {
  ...
  const confirmCard = useCallback(async (
    ...
    trackScanConfirmed(vc.cardNetwork, "scan");
