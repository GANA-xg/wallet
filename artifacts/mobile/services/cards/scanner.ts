...
import { trackOcrCompleted, trackQualityFailed } from "./analytics";
...
export async function processCapturedImage(
  ...
  try {
    ...
    if (!qualityResult.passed) {
      ...
      trackQualityFailed(failedChecks, retryCount);
    ...
    trackOcrCompleted(ocrResult.overallConfidence, fieldsFound);
